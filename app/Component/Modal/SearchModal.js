...
class SearchModal extends React.Component {
    constructor(props) {
        super(props);
        this.state = { users: [{ id: 1, name: "太郎 山田", live: "東京都 世田谷区", age: 18, work: "" }] };
        this.style = {
            background: {
